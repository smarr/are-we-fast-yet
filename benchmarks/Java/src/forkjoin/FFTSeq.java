 ...
 * power of 2.
 */
public class FFTSeq extends Benchmark {
  ...
  private static class ComputeWCoefficients extends RecursiveAction {
    ...
    protected void compute() {
      if (b - a < 128) {
        ...
        final int ab = (a + b) / 2;
        new ComputeWCoefficients(n, a, ab, W).compute();
    ...
    protected void compute() {
      ...
      if (b - a < 16) {
        ...
        final int ab = (a + b) / 2;
        new Unshuffle(a, ab, startIndexInOut, in, out, r, m).compute();
    ...
    protected void compute() {
      if (a == b - 1) {
        ...
        new FftTwiddleGen(a, i2, startIndexInOut, in, out, W, nW, nWdn, r, m).compute();
    ...
    protected void compute() {
      if ((b - a) < 128) {
        ...
        new FftTwiddle2(a, ab, startIndexInOut, in, out, W, nW, nWdn, m).compute();
    ...
    protected void compute() {
      if ((b - a) < 128) {
        ...
        final int ab = (a + b) / 2;
        new FftUnshuffle2(a, ab, startIndexInOut, in, out, m).compute();
    ...
    protected void compute() {
	    ...
	    if ((b - a) < 128) {
	      ...
	      final int ab = (a + b) / 2;
	      new FftTwiddle4(a, ab, startIndexInOut, in, out, W, nW, nWdn, m).compute();
    ...
    protected void compute() {
	    if ((b - a) < 128) {
	      ...
	      final int ab = (a + b) / 2;
	      new FftUnshuffle4(a, ab, startIndexInOut, in, out, m).compute();
    ...
    protected void compute() {
	    ...
	    if ((b - a) < 128) {
	      ...
	      final int ab = (a + b) / 2;
	      new FftTwiddle8(a, ab, startIndexInOut, in, out, W, nW, nWdn, m).compute();
  ...
  private static class FftUnshuffle8 extends BasicTask {
    ...
    protected void compute() {
      if ((b - a) < 128) {
        ...
        final int ab = (a + b) / 2;
        new FftUnshuffle8(a, ab, startIndexInOut, in, out, m).compute();
    ...
    protected void compute() {
      ...
      if ((b - a) < 128) {
        ...
        final int ab = (a + b) / 2;
        new FftTwiddle16(a, ab, startIndexInOut, in, out, W, nW, nWdn, m).compute();
    ...
    protected void compute() {
	    if ((b - a) < 128) {
	      ...
	      final int ab = (a + b) / 2;
	      new FftUnshuffle16(a, ab, startIndexInOut, in, out, m).compute();
    ...
    protected void compute() {
  		...
  		if ((b - a) < 128) {
  			...
  			final int ab = (a + b) / 2;
  			new FftTwiddle32(a, ab, startIndexInOut, in, out, W, nW, nWdn, m).compute();
    ...
    protected void compute() {
  		if ((b - a) < 128) {
  			...
  			final int ab = (a + b) / 2;
  			new FftUnshuffle32(a, ab, startIndexInOut, in, out, m).compute();
