...
public final class UTSOne extends Benchmark {
  ...
  private static class Core extends RecursiveAction {

    private static final long serialVersionUID = 2813249622277043197L;

    private final UTSOne  uTSNai;
    private final Node parent;
    private final int  i;

    Core(final UTSOne uTSNai, final Node parent, final int i) {
      this.uTSNai = uTSNai;
      this.parent = parent;
      this.i = i;
    }
    ...
    protected void compute() {
      uTSNai.search(uTSNai.new Node(parent, i));
    }
  }
