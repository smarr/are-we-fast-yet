...
public final class LUDecompositionSeq extends Benchmark {
  ...
  private static class Schur extends RecursiveAction {
    ...
    private final LUDecompositionSeq lu;
    ...
    protected void compute() {
      ...
      new Schur(posMR, posMC, posVR, posVC, posWR, posWC, halfNb, lu).compute();
      new Schur(posMR, posM01C, posVR, posVC, posWR, posW01C, halfNb, lu).compute();
      new Schur(posM10R, posMC, posV10R, posVC, posWR, posWC, halfNb, lu).compute();
      new Schur(posM11R, posM11C, posV10R, posVC, posWR, posW01C, halfNb, lu).compute();


      new Schur(posMR, posMC, posVR, posV01C, posW10R, posWC, halfNb, lu).compute();
      new Schur(posMR, posM01C, posVR, posV01C, posW11R, posW11C, halfNb, lu).compute();
      new Schur(posM10R, posMC, posV11R, posV11C, posW10R, posWC, halfNb, lu).compute();
      new Schur(posM11R, posM11C, posV11R, posV11C, posW11R, posW11C, halfNb, lu).compute();
    }
  }
  ...
  private static class LowerSolve extends RecursiveAction {
    ...
    LowerSolve(final int posMR, final int posMC, final int posLR,
        final int posLC, final int numOfBlocks, final LUDecompositionSeq lu) {
      this.posMR = posMR;
      this.posMC = posMC;
      this.posLR = posLR;
      this.posLC = posLC;
    ...
    protected void compute() {
      ...
      new AuxLowerSolve(posMR, posMC, posM10R, posMC, posLR,
          posLC, halfNb, lu).compute();
      new AuxLowerSolve(posMR, posM01C, posM11R, posM11C,
          posLR, posLC, halfNb, lu).compute();
    }
  }
  ...
  private static class AuxLowerSolve extends RecursiveAction {
    ...
    AuxLowerSolve(final int posMaR, final int posMaC, final int posMbR,
        ...
        final int numOfBlocks, final LUDecompositionSeq lu) {
      this.posMaR = posMaR;
      this.posMaC = posMaC;
      this.posMbR = posMbR;
      this.posMbC = posMbC;
  ...
  private static class UpperSolve extends RecursiveAction {
    ...
    UpperSolve(final int posMR, final int posMC, final int posUR,
        final int posUC, final int numOfBlocks, final LUDecompositionSeq lu) {
      this.posMR = posMR;
      this.posMC = posMC;
      this.posUR = posUR;
      this.posUC = posUC;
    ...
    protected void compute() {
      ...
      new AuxUpperSolve(posM00R, posM00C, posM01R, posM01C,
          posUR, posUC, halfNb, lu).compute();
      new AuxUpperSolve(posM10R, posM10C, posM11R, posM11C,
          posUR, posUC, halfNb, lu).compute();
    }
  }
  ...
  private void calcLU(final int posR, final int posC, final int numOfBlocks) {
    ...
    new LowerSolve(pos01R, pos01C, pos00R, pos00C, halfNb, this).compute();
    new UpperSolve(pos10R, pos10C, pos00R, pos00C, halfNb, this).compute();
