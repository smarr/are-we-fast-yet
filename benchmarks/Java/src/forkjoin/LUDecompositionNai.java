...
public final class LUDecompositionNai extends Benchmark {
  ...
  private static class Schur extends RecursiveAction {
    ...
    private final LUDecompositionNai lu;
  ...
  private static class LowerSolve extends RecursiveAction {
    ...
    LowerSolve(final int posMR, final int posMC, final int posLR,
        final int posLC, final int numOfBlocks, final LUDecompositionNai lu) {
      this.posMR = posMR;
      this.posMC = posMC;
      this.posLR = posLR;
      this.posLC = posLC;
  ...
  private static class AuxLowerSolve extends RecursiveAction {
    ...
    AuxLowerSolve(final int posMaR, final int posMaC, final int posMbR,
        ...
        final int numOfBlocks, final LUDecompositionNai lu) {
      this.posMaR = posMaR;
      this.posMaC = posMaC;
      this.posMbR = posMbR;
      this.posMbC = posMbC;
  ...
  private static class UpperSolve extends RecursiveAction {
    ...
    UpperSolve(final int posMR, final int posMC, final int posUR,
        final int posUC, final int numOfBlocks, final LUDecompositionNai lu) {
      this.posMR = posMR;
      this.posMC = posMC;
      this.posUR = posUR;
      this.posUC = posUC;
