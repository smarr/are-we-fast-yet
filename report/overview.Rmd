...
vms_fast <- c("Crystal",
              ...
              "AkkaActor", "JetlangActor", "ScalazActor",
...
data <- load_data_file("data/all/138-savina-9da9feb6/benchmark.data")
# data <- load_all_data("data/all", "benchmark.data")

data <- droplevels(subset(data,
                          select = c(Value, Unit, Benchmark, VM, Iteration, version, sha)))
