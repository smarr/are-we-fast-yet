...
vm_names <- c(
  "TruffleRuby-NativeCE-int" = "TruffleRuby 21.3 NativeCE int", 
  "TruffleRuby-NativeCE-jit" = "TruffleRuby 21.3 NativeCE jit",
  
  "Java-GraalCE-jit" = "Graal CE 21.3 jit",
  "Java-GraalEE-jit" = "Graal EE 21.3 jit", 
  "Java17-C2-jit"    = "HotSpot C2 17 jit",
  "Java8-C2-jit"     = "HotSpot C2  8 jit",
  "Java8-int" = "HotSpot 8 int",
  "Java17-int" = "HotSpot 17  int",

  "CRuby27-int" =  "CRuby 2.7 int",
  "CRuby30-int" =  "CRuby 3.0 int",
  
  "Node-jit"              = "Node 17.0 jit",
  "Node-int"              = "Node 17.0 int",
  ...
  "TruffleSOM-ast-CE-jit" = "TruffleSOM ast CE jit", 
  "TruffleSOM-bc-CE-jit" = "TruffleSOM bc CE jit",
  "TruffleSOM-bc-NativeCE-int" = "TruffleSOM bc NativeCE int",
  "TruffleSOM-ast-NativeCE-int" = "TruffleSOM ast NativeCE int", 
  "SOM-Java17-C2" = "SOM HotSpot 17 C2 int"
)

vms_all  <- names(vm_names)
vms_slow <- c("Java8-int", "Java17-int",
              "CRuby27-int", "CRuby30-int",
              "PySOM-bc-int", "PySOM-ast-int",
              "Node-int", 
              "TruffleSOM-bc-NativeCE-int",
              "TruffleSOM-ast-NativeCE-int",
              "TruffleRuby-NativeCE-int", 
              "SOM-Java17-C2")
vms_fast <- c("TruffleRuby-NativeCE-jit", 
              "Java-GraalCE-jit", "Java-GraalEE-jit", "Java17-C2-jit", "Java8-C2-jit",
              "Node-jit",
...
```{r java-overview, fig.width=8, fig.height=6}
p <- overview_box_plot(stats_latest, vms_all %>% str_subset("^Java"))
p + scale_y_continuous(breaks = c(0, 5, seq(from=10, by=10, to=100)))
```
