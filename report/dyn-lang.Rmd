...
vm_colors[["Graal.js EE 22.0.0.2 Hotspot"]]       <- "#c4a000"
vm_colors[["Node.js 17.5 jitless"]]               <- "#edd400"
vm_colors[["Graal.js EE 22.0.0.2 Native Int"]]    <- "#fce94f"

vm_colors[["PyPy 3.8 7.3.7"]]                     <- "#2a5703"
vm_colors[["GraalPython EE 22.0.0.2 Hotspot"]]    <- "#4e9a06"
vm_colors[["CPython 3.10"]]                       <- "#73d216"
vm_colors[["GraalPython EE 22.0.0.2 Native Int"]] <- "#b7f774"

vm_colors[["Ruby 3.1.0"]]                         <- "#3465a4"
vm_colors[["TruffleRuby EE 22.0.0.2 Hotspot"]]    <- "#204a87"
vm_colors[["TruffleRuby EE 22.0.0.2 Native Int"]] <- "#97c4f0"
...
overview_box_plot(
  results_int$stats$bench, vms = vms_dyn_int,
