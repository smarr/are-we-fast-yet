...
ggsave(plot, device= cairo_pdf, path=".", filename="rss-interp.pdf", dpi=300, height=100, width=200, units="mm", family="Arial")
...
#print(kable(df2), type="latex", comment=FALSE)
plot <- box_plot_rss(box_plot_data)
ggsave(plot, device= cairo_pdf, path=".", filename="rss-jit.pdf", dpi=300, height=100, width=200, units="mm", family="Arial")
