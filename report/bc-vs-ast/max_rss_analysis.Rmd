...
get_data_for_box_plot <- function(all_data, exe_names, baseline_name) {
...
```{r rss-interp, fig.width=8, fig.height=2.2}
...
#ggsave("rss-interp.pdf", plot, dpi = 300, device="pdf", fonts = c("Arial"))
#ggsave(plot, device= cairo_pdf, path=".",filename=paste("osef","plot", sep="_"), height =300, width = 500, units="mm", family="Arial")
...
```{r rss-jit, fig.width=8, fig.height=2.2}
box_plot_data <- get_data_for_box_plot(data_rss, 
