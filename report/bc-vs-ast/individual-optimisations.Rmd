...
get_tsom_ast_data <- function() {
  ...
  no_inline_caching <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2695") %>% mutate(optim = "no inline caching")
  no_global_caching <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2694") %>% mutate(optim = "no global caching")
  no_lowered_control_structs <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2669") %>% mutate(optim = "no lowered control structs")
  ...
  no_supernodes <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2684") %>% mutate(optim = "no supernodes")
  
  data_optim <- rbind(based_on_what, no_localnonlocal_vars, no_inline_caching, 
                               no_global_caching, no_lowered_control_structs, no_blocks_without_context, no_supernodes) %>% filter(criterion == "total")
  data_optim
}
...
get_tsom_bc_data <- function() {
  ...
  no_global_caching <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2686") %>% mutate(optim = "no global caching")
  no_lowered_control_structs <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2703") %>% mutate(optim = "no lowered control structs")
  no_superinstructions <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2715") %>% mutate(optim = "no superinstructions")
  
  data_optim <- rbind(based_on_what, no_bc_inline_caching, no_quickening, no_global_caching, no_lowered_control_structs, no_superinstructions) %>% filter(criterion == "total")
  data_optim
}
...
get_pysom_bc_data <- function() {
  ...
  no_superinstructions <- load_data_url("https://rebench.stefan-marr.de/RPySOM/data/2702") %>% mutate(optim = "no superinstructions")
  no_lowered_control_structs <- load_data_url("https://rebench.stefan-marr.de/RPySOM/data/2709") %>% mutate(optim = "no lowered control structs")
  
  data_optim <- rbind(based_on_what, no_bc_inline_caching, no_global_caching, no_quickening, no_superinstructions, no_lowered_control_structs) %>% filter(criterion == "total")
  data_optim
}
