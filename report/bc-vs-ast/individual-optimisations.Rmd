...
#        load_data_for_experiment(2625, "no blocks without context", project_name),
        ...
        load_data_for_experiment(2816, "no lowering of unneces. prims", project_name)  # YURIA1'D
...
get_pysom_ast_data <- function() {
  ...
  rbind(load_data_for_experiment(2780, "every optimization", project_name), # YURIA1'D
        ...
        load_data_for_experiment(2811, "no lowered control structs", project_name), # YURIA1'D
#        load_data_for_experiment(2658, "no blocks without context", project_name),
        load_data_for_experiment(2812, "no lowering of unneces. prims", project_name) # YURIA1'D
        ) %>% filter(criterion == "total")
}
