...
plot <- box_plot_optim(box_plot_data, colors=color_set)
ggsave(plot, device= cairo_pdf, path=".", filename="optim-tsom-bc-int.pdf", dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set)
ggsave(plot, device= cairo_pdf, path=".", filename="optim-pysom-bc-int.pdf", dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set)
ggsave(plot, device= cairo_pdf, path=".", filename="optim-tsom-bc-jit.pdf", dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set)
ggsave(plot, device= cairo_pdf, path=".", filename="optim-pysom-bc-jit.pdf", dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
