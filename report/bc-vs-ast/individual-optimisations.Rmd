...
get_tsom_ast_data <- function() {
  ...
  rbind(load_data_for_experiment(2622, "every optimisation", project_name), 
        ...
        load_data_for_experiment(2684, "no supernodes", project_name),
        load_data_for_experiment(2666, "no lowering of prims", project_name)  # not very good commit, or final
...
get_pysom_ast_data <- function() {
  ...
  rbind(load_data_for_experiment(2662, "every optimisation", project_name), 
        ...
        load_data_for_experiment(2740, "no lowering of prims", project_name)
        ) %>% filter(criterion == "total")
}
...
get_tsom_bc_data <- function() {
  ...
  rbind(load_data_for_experiment(2622, "every optimisation", project_name), 
        ...
        load_data_for_experiment(2715, "no superinstructions", project_name),
        load_data_for_experiment(2666, "no lowering of prims", project_name)  # not very good commit, or final
        ) %>% filter(criterion == "total")
}
