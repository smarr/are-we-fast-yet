...
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-tsom-ast-int.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-pysom-ast-int.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
box_plot_data <- get_data_for_box_plot_optim(data_optim_tsom_ast, "TruffleSOM-graal", iteration_threshold = MIN_JIT_ITERATION)

plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-tsom-ast-jit.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
box_plot_data <- get_data_for_box_plot_optim(data_optim_pysom_ast, "RPySOM-ast-jit", iteration_threshold = MIN_JIT_ITERATION)
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-pysom-ast-jit.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-tsom-bc-int.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-pysom-bc-int.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
box_plot_data <- get_data_for_box_plot_optim(data_optim_tsom_bc, "TruffleSOM-graal-bc", iteration_threshold = MIN_JIT_ITERATION)
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-tsom-bc-jit.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
box_plot_data <- get_data_for_box_plot_optim(data_optim_pysom_bc, "RPySOM-bc-jit", iteration_threshold = MIN_JIT_ITERATION)
plot <- box_plot_optim(box_plot_data, colors=color_set_optims)
ggsave(plot, device= cairo_pdf, path=".", filename=output_folder_path("optim-pysom-bc-jit.pdf"), dpi=300, height=OPTIM_GRAPH_HEIGHT, width=OPTIM_GRAPH_WIDTH, units="mm", family="Arial")
plot
```
...
stats_tsom_ast_jit <- compute_stats(data_optim_tsom_ast, "TruffleSOM-graal", iteration_threshold = MIN_JIT_ITERATION)$stats
stats_tsom_bc_jit <- compute_stats(data_optim_tsom_bc, "TruffleSOM-graal-bc", iteration_threshold = MIN_JIT_ITERATION)$stats
...
stats_pyson_ast_jit <- compute_stats(data_optim_pysom_ast, "RPySOM-ast-jit", iteration_threshold = MIN_JIT_ITERATION)$stats
stats_pysom_bc_jit <- compute_stats(data_optim_pysom_bc, "RPySOM-bc-jit", iteration_threshold = MIN_JIT_ITERATION)$stats
```
