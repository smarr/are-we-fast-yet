...
get_data_for_box_plot_optim <- function(input_data, baseline_name) {
  df_baseline <- input_data %>% filter(optim == "baseline") # %>% filter(exe %in% exe_names)
...
box_plot_data <- get_data_for_box_plot_optim(data_optim, baseline)
