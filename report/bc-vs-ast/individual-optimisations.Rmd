...
#        load_data_for_experiment(2625, "blocks without context", project_name),
        ...
        load_data_for_experiment(2816, "lowering of unneces. prims", project_name) 
...
#        load_data_for_experiment(2658, "blocks without context", project_name),
        load_data_for_experiment(2812, "lowering of unneces. prims", project_name)
        ) %>% filter(criterion == "total")
}
...
#        load_data_for_experiment(2874, "local/nonlocal vars", project_name),
        load_data_for_experiment(2884, "inlining control struc.", project_name),
        load_data_for_experiment(2863, "lowering of unneces. prims", project_name),
...
get_pysom_ast_data <- function() {
  ...
  rbind(load_data_for_experiment(2873, "all optimizations", project_name),
        ...
        load_data_for_experiment(2891, "inlining control struc.", project_name),
        load_data_for_experiment(2764, "inline caching", project_name), # OLD DATA        
        load_data_for_experiment(2891, "lowering of unneces. prims", project_name)
        ) %>% filter(criterion == "total")
}
...
macros = c(
    Cmd("TSOMastInlineStructMedianX",
        X2((stats_tsom_ast_int |> filter(optim == "inlining control struc."))$median)),
    Cmd("TSOMastInlineStructMaxX",
        X2((stats_tsom_ast_int |> filter(optim == "inlining control struc."))$max)),
    Cmd("TSOMastInlineStructMinX",
        X2((stats_tsom_ast_int |> filter(optim == "inlining control struc."))$min)),
    
    Cmd("PySOMastInlineStructMedianX",
        X2((stats_pysom_ast_int |> filter(optim == "inlining control struc."))$median)),
    Cmd("PySOMastInlineStructMaxX",
        X2((stats_pysom_ast_int |> filter(optim == "inlining control struc."))$max)),
    Cmd("PySOMastInlineStructMinX",
        X2((stats_pysom_ast_int |> filter(optim == "inlining control struc."))$min)),
    
    Cmd("TSOMbcInlineStructMedianX",
        X2((stats_tsom_bc_int |> filter(optim == "inlining control struc."))$median)),
    Cmd("TSOMbcInlineStructMaxX",
        X2((stats_tsom_bc_int |> filter(optim == "inlining control struc."))$max)),
    Cmd("TSOMbcInlineStructMinX",
        X2((stats_tsom_bc_int |> filter(optim == "inlining control struc."))$min)),
    
    Cmd("PySOMbcInlineStructMedianX",
        X2((stats_pysom_bc_int |> filter(optim == "inlining control struc."))$median)),
    Cmd("PySOMbcInlineStructMaxX",
        X2((stats_pysom_bc_int |> filter(optim == "inlining control struc."))$max)),
    Cmd("PySOMbcInlineStructMinX",
        X2((stats_pysom_bc_int |> filter(optim == "inlining control struc."))$min)),
