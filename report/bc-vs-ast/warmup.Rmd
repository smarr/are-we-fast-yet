...
get_warmup_plots <- function(data, baseline_name) {
...
OUTPUT_WIDTH <- 250
OUTPUT_HEIGHT <- 150
ggsave(plot_graal, device= cairo_pdf, path=".", filename=paste0("output_graphs_warmup/", "warmup_graal.pdf"), dpi=300, height=OUTPUT_HEIGHT, width=OUTPUT_WIDTH, units="mm", family="Arial")
ggsave(plot_native, device= cairo_pdf, path=".", filename=paste0("output_graphs_warmup/", "warmup_native.pdf"), dpi=300, height=OUTPUT_HEIGHT, width=OUTPUT_WIDTH, units="mm", family="Arial")
ggsave(plot_pysom, device= cairo_pdf, path=".", filename=paste0("output_graphs_warmup/", "warmup_pysom.pdf"), dpi=300, height=OUTPUT_HEIGHT, width=OUTPUT_WIDTH, units="mm", family="Arial")
```
