...
macros = c(
  Cmd("progRepAstOverheadPySomWOExecX",
         X2((norm |> filter(exe == "PySOM AST", bench == "TestGC"))$ratio)),
  Cmd("progRepAstOverheadPySomWithExecX",
         X2((norm |> filter(exe == "PySOM AST", bench == "Test"))$ratio)),
  Cmd("progRepAstOverheadTrSomWOExecX",
         X2((norm |> filter(exe == "TrSOM AST", bench == "TestGC"))$ratio)),
  Cmd("progRepAstOverheadTrSomWithExecX",
         X2((norm |> filter(exe == "TrSOM AST", bench == "Test"))$ratio)),
