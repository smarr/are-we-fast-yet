...
if (Sys.getenv("RSTUDIO") == "1") { if (Sys.getenv("USER") == "smarr") { setwd("/Users/smarr/Projects/ast-vs-bc-interp/are-we-fast-yet/report/bc-vs-ast") } else { setwd("/home/octavel/PhD/papers/ast-vs-bc-interp/are-we-fast-yet/report/bc-vs-ast") } }
source("scripts/libraries.R", chdir=TRUE)
source("scripts/data-processing2.R")
options(dplyr.summarise.inform = FALSE) # TODO REMOVE THAT
...
data_repr_tsom <- load_data_url("https://rebench.stefan-marr.de/TruffleSOM/data/2818") %>% 
    filter(criterion == "Allocated") %>% 
