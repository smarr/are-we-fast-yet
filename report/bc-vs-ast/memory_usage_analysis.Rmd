...
get_data_program_representation <- function(data) {
  ...
  data_repr_pysom <- load_data_url("https://rebench.stefan-marr.de/RPySOM/data/2750")
...
## BCvsAST - Interp
```{r program-repr-memory-int, fig.width=8, fig.height=2.2, echo=FALSE}
...
## BCvsAST - JIT
```{r program-repr-memory-jit, fig.width=8, fig.height=2.2, echo=FALSE}
data <- get_data_for_box_plot_repr(data_repr, 
                                   "RPySOM-bc-jit",
                                   c("RPySOM-bc-jit", "RPySOM-ast-jit", "TruffleSOM-graal", "TruffleSOM-graal-bc"))
