...
ggsave(plot, device= cairo_pdf, path=".", filename=paste0(output_folder, "/rss-interp-pysom.pdf"), dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data, parse_y_labels = TRUE)
ggsave(plot, device= cairo_pdf, path=".", filename=paste0(output_folder, "/rss-interp-tsom.pdf"), dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data, parse_y_labels = TRUE)
ggsave(plot, device= cairo_pdf, path=".", filename=paste0(output_folder, "/rss-jit-pysom.pdf"), dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data, parse_y_labels = TRUE)
ggsave(plot, device= cairo_pdf, path=".", filename=paste0(output_folder, "/rss-jit-tsom.pdf"), dpi=300, height=50, width=100, units="mm", family="Arial")
