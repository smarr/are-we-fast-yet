...
get_data_for_box_plot_rss <- function(all_data, baseline_name, exe_names=NULL) {
...
get_data_for_box_plot_repr <- function(all_data, baseline_name, exe_names=NULL) {
  if (!is.null(exe_names)) {
    df <- data_repr %>% filter(exe %in% exe_names)
  } else {
    df <- data_repr
  }
...
ggsave(plot, device= cairo_pdf, path=".", filename="rss-interp-pysom.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data)
ggsave(plot, device= cairo_pdf, path=".", filename="rss-interp-tsom.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data)
ggsave(plot, device= cairo_pdf, path=".", filename="rss-jit-pysom.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_in_kb(box_plot_data)
ggsave(plot, device= cairo_pdf, path=".", filename="rss-jit-tsom.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
...
data <- get_data_for_box_plot_repr(data_repr, 
                                   "RPySOM-bc-interp",
                                   c("RPySOM-bc-interp", "RPySOM-ast-interp","TruffleSOM-native-interp-bc", "TruffleSOM-native-interp-ast"))

plot <- box_plot_rss(data)
ggsave(plot, device= cairo_pdf, path=".", filename="program-repr-interp.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
...
plot <- box_plot_rss(data)
ggsave(plot, device= cairo_pdf, path=".", filename="program-repr-jit.pdf", dpi=300, height=50, width=100, units="mm", family="Arial")
